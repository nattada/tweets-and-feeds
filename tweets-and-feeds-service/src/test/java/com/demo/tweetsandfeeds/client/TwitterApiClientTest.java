...
import com.demo.tweetsandfeeds.client.model.response.TweetError;
...
public class TwitterApiClientTest {
    ...
    public void returnErrorWhenUnauthorized() throws IOException, InterruptedException{
        ...
        when(mockResponse.statusCode()).thenReturn(HttpStatus.SC_UNAUTHORIZED);
        ...
        TweetError tweetResponse = (TweetError) twitterApiClient.searchTweets("test", "bearerToken");
        assertEquals(String.valueOf(HttpStatus.SC_UNAUTHORIZED), tweetResponse.getStatus());
    ...
    public void returnTweetDataWhenRequestIsSuccessfulWithOkStatus() throws IOException, InterruptedException{
        ...
        TweetError tweetResponse = (TweetError) twitterApiClient.searchTweets("test", "bearerToken");
        assertEquals(String.valueOf(HttpStatus.SC_OK), tweetResponse.getStatus());
